...
export const HELP_ENTRIES: HelpEntry[] = [
  ...
  },
  {
    ...
    formula:
      'cost = (input_tokens × rate.input + output_tokens × rate.output + cache_creation_input_tokens × rate.cacheWrite + cache_read_input_tokens × rate.cacheRead) / 1_000_000. Rates (USD per 1M tokens) as of 2026: Opus — input $15, output $75, cacheWrite $18.75, cacheRead $1.50; Sonnet — input $3, output $15, cacheWrite $3.75, cacheRead $0.30; Haiku — input $1, output $5, cacheWrite $1.25, cacheRead $0.08. Model is matched by checking whether the model string contains "opus", "sonnet", or "haiku" (case-insensitive).',
    caveats:
